...
export default function Generation1List() {
  ...
  return (
    <>
      ...
      <h1 className="text-4xl py-5 text-center ">Generation 1</h1>

      {/*  */}
      {/*  Creating links to the next generation */}
      {/*  */}

      <div>
        <Link
          href="/generation/2"
          className="absolute top-20 end-48 bg-blue-200 px-5 py-2 rounded-full hover:bg-yellow-500 hover:text-blue-700 text-s font-bold tracking-wider"
        >
          Generation 2
        </Link>
      </div>
